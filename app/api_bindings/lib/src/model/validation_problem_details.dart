...
class ValidationProblemDetails {
  ...
  factory ValidationProblemDetails.fromJson(Map<String, dynamic> json) =>
      _$ValidationProblemDetailsFromJson(json);

  Map<String, dynamic> toJson() => _$ValidationProblemDetailsToJson(this);
