...
@RoutePage()
class ChatHostPage extends StatefulHookConsumerWidget {
  const ChatHostPage({super.key});

  @override
  ConsumerState<ChatHostPage> createState() => ChatHostPageState();
}

class ChatHostPageState extends ConsumerState<ChatHostPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final view = DeviceUtils.isPhone
        ? PageView(
