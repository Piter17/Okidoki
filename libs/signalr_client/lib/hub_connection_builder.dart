...
class HubConnectionBuilder {
  ...
  DeserializeCallback? _deserializeCallback;
  ...
  /// Configure DeserializeCallback
  HubConnectionBuilder configureDeserializeCallback(
  ...
  HubConnection build() {
    ...
    return HubConnection.create(connection, _logger,
        _protocol ?? JsonHubProtocol(), _deserializeCallback,
