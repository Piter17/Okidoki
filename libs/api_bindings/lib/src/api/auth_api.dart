...
import 'package:api_bindings/src/deserialize.dart';
...
class AuthApi {
  ...
  Future<Response<void>> addCredentials({
    required AddCredentialsRequest addCredentialsRequest,
    ...
    final _path = r'/api/auth/credentials';
    ...
    try {
      _bodyData = jsonEncode(addCredentialsRequest);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InfoResponse>> getInfo({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/auth/manage/info';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<InfoResponse, InfoResponse>(
              rawData,
              'InfoResponse',
              growable: true,
            );
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> mapIdentityApiApiAuthConfirmEmail({
    ...
    final _path = r'/api/auth/confirmEmail';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
    ...
    final _queryParameters = <String, dynamic>{
      r'userId': userId,
      r'code': code,
      if (changedEmail != null) r'changedEmail': changedEmail,
    };
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TwoFactorResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TwoFactorResponse>> post2fa({
    required TwoFactorRequest twoFactorRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/auth/manage/2fa';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      _bodyData = jsonEncode(twoFactorRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
    ...
    TwoFactorResponse? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<TwoFactorResponse, TwoFactorResponse>(
              rawData,
              'TwoFactorResponse',
              growable: true,
            );
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postForgotPassword({
    ...
    final _path = r'/api/auth/forgotPassword';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  /// Returns a [Future] containing a [Response] with a [InfoResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InfoResponse>> postInfo({
    ...
    try {
      _bodyData = jsonEncode(infoRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccessTokenResponse>> postLogin({
    ...
    final _queryParameters = <String, dynamic>{
      if (useCookies != null) r'useCookies': useCookies,
      if (useSessionCookies != null) r'useSessionCookies': useSessionCookies,
    };
  ...
  /// Returns a [Future] containing a [Response] with a [AccessTokenResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccessTokenResponse>> postRefresh({
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postResendConfirmationEmail({
    required ResendConfirmationEmailRequest resendConfirmationEmailRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/auth/resendConfirmationEmail';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    try {
      _bodyData = jsonEncode(resendConfirmationEmailRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> postResetPassword({
    ...
    final _path = r'/api/auth/resetPassword';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  Future<Response<RegisterResponse>> registerUser({
    ...
    final _path = r'/api/auth/registerUser';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
