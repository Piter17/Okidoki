...
class UserProfileApi {
  ...
  Future<Response<UserProfileDto>> getByUserId({
    String? userId,
    String? guildId,
    ...
    final _path = r'/api/UserProfile/GetUserProfile';
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (guildId != null) r'guildId': guildId,
    };
  ...
  /// Returns a [Future] containing a [Response] with a [UserProfileDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserProfileDto>> updateAvatar({
    ...
    final _path = r'/api/UserProfile/SetAvatar';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  /// Returns a [Future] containing a [Response] with a [UserProfileDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserProfileDto>> updateProfile({
    ...
    final _path = r'/api/UserProfile/profile';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    try {
      _bodyData = jsonEncode(updateUserProfileRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
